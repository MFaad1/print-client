                ...
                <Grid item xs={12} sm={12} md={12} lg={7} xl={7}>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            ...
                            <p className="dashboard-box-value">{ordersList && ordersList.totalPagesPrinted}</p>
                            </div>
                        </Grid>
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            <div className="dashboard-box">
                                <p className="dashboard-box-heading">Total Payment</p>
                                <p className="dashboard-box-value">$ {ordersList && ordersList.totalRevenue}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            <div className="dashboard-box">
                                ...
                                <p className="dashboard-box-value">{ordersList && ordersList.totalOrders}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            <div className="dashboard-box">
                                ...
                                <p className="dashboard-box-value">{ordersList && ordersList.totalCompletedJobs}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            <div className="dashboard-box">
                                ...
                                <p className="dashboard-box-value">{ordersList && ordersList.totalPendingJobs}</p>
                            </div>
                        </Grid>
                        ...
                        <Grid item xs={12} sm={4} md={4} lg={4} xl={4}>
                            <div className="dashboard-box">
                                <p className="dashboard-box-heading">Average Job Value</p>
                                <p className="dashboard-box-value">{ordersList && ordersList.averageJobValue}</p>
                                <img src={Graph} />
                            </div>
                        </Grid>
                        <Grid item xs={12} sm={4} md={1} lg={4} xl={4}>
                            <div className="dashboard-box">
                                <p className="dashboard-box-heading">Job Completion Rate</p>
                                <p className="dashboard-box-value">{ordersList && ordersList.jobCompletionRate}</p>
                                <img src={Graph} />
                            </div>
                        </Grid>
                    </Grid>
